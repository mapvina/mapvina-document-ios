# MapVina App Structure

## Overview
This document outlines the organization of the MapVina demo iOS app code. The app has been refactored to follow a more modular, maintainable structure using SwiftUI best practices.
...
- **MapContainer.swift** - UIViewRepresentable wrapper for MapVina map
